...
def apply_watermark():
    bucket_name = "herokuappgruppo5" # INSERT YOUR BUCKET NAME
    ...
    qr_req_url = f"request('https://qrackajack.expeditedaddons.com/?api_key={os.environ['QRACKAJACK_API_KEY']} + '&content=https://{bucket_name}.s3.amazonaws.com/{filename}')"
    ...
    watermark_req_url = f"request('https://watermarker.expeditedaddons.com/?api_key={os.environ['WATERMARKER_API_KEY']} + '&image_url=https://{bucket_name}.s3.amazonaws.com/{filename}')"
